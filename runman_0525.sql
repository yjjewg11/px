...
-- ----------------------------
-- Table structure for `run_time_schedule_relation`
-- ----------------------------
DROP TABLE IF EXISTS `run_time_schedule_relation`;
CREATE TABLE `run_time_schedule_relation` (
...
-- ----------------------------
-- Records of run_time_schedule_relation
-- ----------------------------

-- ----------------------------
-- Table structure for `run_training_course`
-- ----------------------------
DROP TABLE IF EXISTS `run_training_course`;
CREATE TABLE `run_training_course` (
...
-- ----------------------------
-- Records of run_training_course
-- ----------------------------
...
INSERT INTO `run_training_plan` VALUES ('3', '4', null, '我就是我，不一样的烟火', null, null, null, null, null, null, null, '1', null, null, null, '2015-05-24 12:54:56', null, null, null, null);

-- ----------------------------
-- Table structure for `run_upload_file`
-- ----------------------------
DROP TABLE IF EXISTS `run_upload_file`;
CREATE TABLE `run_upload_file` (
...
-- ----------------------------
-- Records of run_upload_file
-- ----------------------------
INSERT INTO `run_upload_file` VALUES ('2', '2c90008a4d66bc67014d66bc67800000', '4', 'head', '2015-05-18 19:15:33', 'H:/runman_upload/head/4_head_2c90008a4d66bc67014d66bc67800000.jpg', 'image/jpeg', '9184');
...
INSERT INTO `run_user` VALUES ('4', '13628037994', '飨受人生', '1', null, '1', null, null, '猜猜猜', '2015-05-24 13:01:04', '1234567890123456', null, null, '0', '2015-05-13', null, '0', null, 'rest/uploadFile/getImgFile.json?guid=2c90008a4d66bc67014d66bc67800000', '成都', '2015-05-18', null, '我就是我，不一样的烟火', null, null, null);

-- ----------------------------
-- Table structure for `run_user_relation_training_course`
-- ----------------------------
DROP TABLE IF EXISTS `run_user_relation_training_course`;
CREATE TABLE `run_user_relation_training_course` (
  `id` bigint(10) NOT NULL auto_increment,
...
-- ----------------------------
-- Records of run_user_relation_training_course
-- ----------------------------
