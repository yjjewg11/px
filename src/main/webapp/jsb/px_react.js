			   	...
			   	contentDiv, 
			    	...
			    	GTimeShow.showByTime(o.create_time), 
     			    	...
     			    	React.createElement("a", {href: "javascript:void(0);"}, React.createElement("i", {id: "btn_reply_"+o.uuid, className: "am-icon-reply px_font_size_click"}), "评论"), 
							...
							React.createElement(G_check_disable_div_byRight, {type: 99, uuid: o.uuid, status: o.status, groupuuid: o.groupuuid, pxadmin: 2, add_class: "am-fr"}), 
...
return (
		  ...
		  this.props.events.data.map(function(event) {
		      return (
				    ...
				    React.createElement(G_check_disable_div_byRight, {type: 98, uuid: event.uuid, status: event.status, groupuuid: groupuuid, 	 pxadmin: 2})
		    		  )
		    		  )
		  })
		  ...
		  div_detail_inhtml=(
				  React.createElement("div", {className: "am-u-lg-6 am-u-md-8 am-u-sm-centered"}, 
					 ...
					 React.createElement("div", {className: "g_teachingplan"}, 
				    	...
				    	React.createElement(Common_Dianzan_show_noAction, {uuid: o.uuid, type: 84, btn_dianzan: "btn_dianzan_"+o.uuid}), 
					  React.createElement(Common_reply_list, {uuid: o.uuid, type: 84})
					) 
		  )
	  }else{
		  edit_btn_className="G_Edit_show";
		  ...
		  React.createElement("div", {className: "px_margin_div"}, 
           ...
           iframe, 
		     ...
		     React.createElement(AMR_Button, {className: edit_btn_className, amStyle: "danger", onClick: this.handleClick.bind(this, "del",obj.groupuuid,obj.uuid)}, "删除")
				...
				React.createElement(G_check_disable_div_byRight, {type: obj.type, uuid: obj.uuid, status: obj.status, groupuuid: obj.groupuuid, add_class: "am-fr", pxadmin: 2}), 
...
return (
	  React.createElement("div", {className: "px_margin_div"}, 
       React.createElement("div", {className: "am-margin-left-sm"}, 	 
	     ...
	     React.createElement(AMR_ButtonToolbar, null, 
	         React.createElement(AMR_Button, {className: "G_Edit_show", amStyle: "secondary", onClick: this.handleClick.bind(this, "edit",obj.groupuuid,obj.uuid)}, "编辑"), 
  ...
  event.disabled ? 'am-disabled' : '';
	    ...
	    return (
	    	    ...
	    	    React.createElement("tr", null, 
                  ...
                  React.createElement("th", null, "班级操作"), 
	    			  ...
	    			  this.props.events.map(function(event) {
	    			      ...
	    			      return (
	    			    	      React.createElement("tr", {className: className}, 
	    			    	        ...
	    			    	        React.createElement("td", null, React.createElement(AMR_Button, {amSize: "xs", amStyle: "secondary", onClick: that.handleClick.bind(this,"edit_class",event)}, "编辑班级")), 
	...
	React.createElement(G_px_help_List, {data: G_px_help_msg.msg_px_help_list13_1}), 
       ...
       React.createElement(AMR_ButtonToolbar, null, 
  	  ...
  	  React.createElement(AMUIReact.Selected, {amSize: "xs", id: "selectclass_uuid2", name: "class_uuid", onChange: this.handleChange_selectclass.bind(this), btnWidth: "200", data: this.props.classList, btnStyle: "primary", value: o.uuid})
  	    ...
  	    React.createElement("div", {className: "am-fl am-margin-left-sm am-margin-bottom-xs"}, 
     	React.createElement(AMUIReact.Selected, {amSize: "xs", btnStyle: "secondary", placeholder: "更多操作", onChange: this.handleClick_download.bind(this,o.groupuuid,o.uuid), btnWidth: "200", multiple: false, data: this.props.down_list})
     	)
	  ), 
    ...
    return (
    		...
    		React.createElement("div", null, 
    		 ...
    		 React.createElement("div", null, 
		          React.createElement(AMR_Panel, null, 
                  React.createElement(AMR_ButtonToolbar, null, 
				 React.createElement("div", {className: "am-f1 am-margin-bottom-sm am-margin-left-xs am-u-lg-3 am-u-sm-6"}, 					    		 
     	  ...
     	  return (
     			  ...
     			  React.createElement("div", {className: "am-comment-main"}, 
     			    ...
     			    React.createElement("div", {className: "am-comment-bd"}, 
     			    	...
     			    	React.createElement(G_check_disable_div_byRight, {type: 99, uuid: o.uuid, pxadmin: 2, status: o.status, groupuuid: o.groupuuid, add_class: "am-fr"}), 
								React.createElement("a", {href: "javascript:void(0);", className: "am-fr", onClick: common_check_illegal.bind(this,99,o.uuid)}, "举报")
     			    	)
     			    	), 
 ...
 render: function() {
     ...
     React.createElement("div", null, 
		  ...
		  React.createElement(AMR_Panel, null, 
           ...
           React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 	
		   React.createElement(AMR_Button, {amStyle: "secondary", onClick: this.addteachingplan_btn.bind(this,"add",{classuuid:o.classuuid,uuid:null})}, "增加单条课程")
		   ), 
           React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 	
		   React.createElement(AMR_Button, {amStyle: "secondary", onClick: this.add_classbtn.bind(this)}, "批量添加课程")	  	  
		   ), 
		   React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 
		   React.createElement(AMR_Button, {amStyle: "danger", onClick: this.Alldeletes_btn.bind(this)}, "删除所有课程")
	       )
		   )
          ), 
  ...
  var Query_Students_EventRow_byRight = React.createClass({displayName: "Query_Students_EventRow_byRight", 
	    ...
	    if(!header_img)header_img=G_def_noImgPath;
  	    ...
  	    return (
  	      React.createElement("tr", {className: className}, 
			React.createElement("td", null, " ", React.createElement(AMUIReact.Image, {id: "img_head_image", width: "28", height: "28", src: header_img})), 
			React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: G_class_students_look_info.bind(this,event.uuid,2,2)}, event.name)), 			
  	        React.createElement("td", null, event.sex=="0"?"男":"女"), 
  	        React.createElement("td", null, event.birthday), 
  	        React.createElement("td", null, event.idcard), 
		    React.createElement("td", null, React.createElement("a", {className: event.ma_tel?"":"am-hide", href: "tel:"+event.ma_tel}, event.ma_tel)), 
