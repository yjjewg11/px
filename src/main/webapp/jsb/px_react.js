		...
		this.props.classlist.map(function(event) {
			  return(
			  	 React.createElement("div", {className: "am-fl am-margin-left-sm am-margin-bottom-xs"}, 
			  	  React.createElement(AMR_Button, {amSize: "xs", className: "am-hide-sm", amStyle: "danger", onClick: px_ajax_teachingplan_fn.bind(this,event.uuid,o.pageNo), round: true}, event.name)
			  	)  			  	  
			  )})
		 ), 
	 	  React.createElement("hr", null), 
...
//		<AMR_Button amSize="xs" amStyle="secondary" onClick={this.pageClick.bind(this, "pre")}  round>上周</AMR_Button>
//		</div> 
//		<div className="am-fl am-margin-left-sm am-margin-bottom-xs">
//		<AMR_Button amSize="xs" amStyle="secondary" onClick={this.pageClick.bind(this, "next")} round>下周</AMR_Button>	
//		</div> 
//		{this.state.classlist.map(function(event) {
//			  return(
//			  	 <div className="am-fl am-margin-left-sm am-margin-bottom-xs">
//			  	  <AMR_Button amSize="xs" className="am-hide-sm" amStyle="danger" onClick={thit.px_biaoqian_button.bind(this,event.value)} round>{event.label}</AMR_Button>
//			  	</div>  			  	  
//			  )})}
//		  </AMR_ButtonToolbar>
//		<hr/>
...
//			    		  < AMR_Button className="am-margin-left" amStyle ="warning" onClick={this.edit.bind(this,{afternoon:"",classuuid:o.classuuid,morning:"",plandate:o.plandate,uuid:null})} round >添加课程</AMR_Button >
//			    		  </div>
//					  </h3>
//					  </div>
//					  <div className="am-panel-bd">
//						<AMR_Button className={edit_btn_className} amSize="xs" amStyle="secondary" onClick={this.edit.bind(this,o)}  round>{o.name}</AMR_Button>
//
//
//				    		<div className="am-g">
//				    		{dianzan}
...
render: function() {
  ...
  return (			
		  ...
		  React.createElement(AMR_ButtonToolbar, {className: "am-cf am-margin-left-xs"}, 
		  React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 
		  React.createElement(AMUIReact.Selected, {id: "selectgroup_uuid", name: "group_uuid", onChange: this.refresh_data.bind(this), data: this.props.group_list, btnStyle: "primary", value: this.state.groupuuid})
		  ), 
		  React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 
	    			  ...
	    			  this.props.events.map(function(event) {
	    			      ...
	    			      return (
	    			    	      ...
	    			    	      React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
	    			    	        ...
	    			    	        React.createElement("td", null, React.createElement(AMUIReact.Button, {onClick: px_ajax_teachingplan_byRight.bind(this,event.groupuuid,event.uuid,event.courseuuid), amStyle: "success"}, "管理")), 
	    			                disable, 
	       ...
	       React.createElement("label", {className: one_classDiv}, "课程名："), 
		     React.createElement("div", {className: two_classDiv}, 
		       ...
		       React.createElement("label", {className: one_classDiv}, "日期："), 
  		      React.createElement("div", {className: two_classDiv}, 
  		     React.createElement(PxInput, {icon: "birthday-cake", type: "text", maxLength: "25", placeholder: "YYYY-MM-DD", name: "plandateStr", value: o.plandate, onChange: this.handleChange})
		    ), 	 
 	  ...
 	  render: function() {
 	    var event = this.props.event;
 	 	var className = event.highlight ? 'am-active' :
 	  	...
 	  	return (
 	  	  React.createElement("tr", {className: className}, 
 	  	    React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: px_ajax_class_course_look_info.bind(this,event)}, event.title), React.createElement(AMR_Button, {amSize: "xs", amStyle: "secondary", onClick: this.handleChange_button.bind(this,event), round: true}, "修改")), 
 		 ...
 		 return (
 			    ...
 			    React.createElement(AMUIReact.List, {static: true, border: true, striped: true}, 
 				  ...
 				  React.createElement("br", null), 	      
 			       ...
 			       React.createElement(AMUIReact.ListItem, null, "具体课程:", o.birthday), 
 			      React.createElement(AMUIReact.ListItem, null, "上课地点:", o.address), 
 			     React.createElement(AMUIReact.ListItem, null, "课程时长:", o.schedule), 
...
//         load_more_data	重新绘制DIV；
 ...
 //——————————————————————————优惠活动<绘制>—————————————————————  
   ...
   var Preferential_px_Div_list = React.createClass({displayName: "Preferential_px_Div_list", 
   	...
   	load_more_data:function(){
   		$("#"+this.classnewsreply_list_div).append("<div id="+this.classnewsreply_list_div+this.pageNo+">加载中...</div>");
   		var re_data=ajax_Preferential_px_list(this.classnewsreply_list_div+this.pageNo,this.pageNo);
   		if(!re_data)return;
   		if(re_data.data.length<re_data.pageSize){
   			$("#"+this.load_more_btn_id).hide();
   		}else{
...
//         load_more_data	重新绘制DIV；
   ...
   render: function() {
     ...
     return (			
		   ...
		   React.createElement(AMR_ButtonToolbar, null, 
		    React.createElement(AMR_Button, {amStyle: "primary", onClick: this.handleClick.bind(this, "add",this.props.groupuuid), round: true}, "创建优惠活动")
		    ), 
...
* */    
  ...
  var editor= $('#announce_message').xheditor(xhEditor_upImgOption_mfull);
   ...
   render: function() {
   	 var o = this.state;
   	 console.log("o.type",this.props.begDateStr,this.props.endDateStr);
   	  var type_div;
   	  if (announce_types==2) {
   		  type_div= 
   			   React.createElement("div", {className: "am-form-group", id: "div_classuuids"}, 
 ...
 //——————————————————————————<发布对外老师资料>老师资料<管理模块绘制>——————————————————————————  
   ...
   var Teacher_div = React.createClass({displayName: "Teacher_div", 
    ...
    getInitialState: function() {
     ...
     var re_data=ajax_teacher_listByGroup_byRight(this.classnewsreply_list_div+this.pageNo,$("input[name='group_uuid']").val(),this.pageNo,callback);		  
   	},
   	refresh_data:function(){
//   		classnewsreply_list_div 清除；
//         load_more_data	重新绘制DIV；
   ...
   render: function() {
     ...
     return (			
   		  ...
   		  React.createElement(AMR_ButtonToolbar, {className: "am-cf am-margin-left-xs"}, 
   		  React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 
   		  React.createElement(AMUIReact.Selected, {id: "selectgroup_uuid", name: "group_uuid", onChange: this.refresh_data.bind(this), data: this.props.grouplist, btnStyle: "primary", value: this.state.groupuuid})
   		  ), 
   		  React.createElement("div", {className: "am-fl am-margin-bottom-sm am-margin-left-xs"}, 
          React.createElement(AMR_Button, {amSize: "xs", amStyle: "secondary", onClick: this.handleChange_button.bind(this,this.props.groupuuid), round: true}, "新增资料")
		  )
   		  ), 	
...
var Teacher_EventsTable_byRight = React.createClass({displayName: "Teacher_EventsTable_byRight", 
  	 handleChange_button: function(event) {
 		 px_teacher_onClick_byRight("eit",event);
 	 	  },
	  render: function() {
	    var event = this.props.events;
	    var className = event.highlight ? 'am-active' :
		    	 ...
		    	 React.createElement("tr", null, 
	              ...
	              React.createElement("th", null, "发布状态")
	    			  ...
	    			  this.props.events.map(function(event) {
	    			      return (
	    			    	      React.createElement("tr", {className: className}, 
	    			     	  	    React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: px_ajax_teacher_look_info.bind(this,event)}, event.name), React.createElement(AMR_Button, {amSize: "xs", amStyle: "secondary", onClick: this.handleChange_button.bind(this,event), round: true}, "修改")), 
	    			    	        React.createElement("td", null, event.course_title), 
		 ...
		 return (
			    ...
			    React.createElement(AMUIReact.List, {static: true, border: true, striped: true}, 
				  ...
				  React.createElement("br", null), 	      
			          ...
			          React.createElement(AMUIReact.ListItem, null, "老师姓名:", o.title), 
...
return (
		React.createElement("form", {id: "editTeacherForm", method: "post", className: "am-form"}, 
			...
			React.createElement("div", null, 
           React.createElement(AMUIReact.Image, {id: "img_head_image", src: G_imgPath+o.img, className: "G_img_header"}), 
           React.createElement("button", {type: "button", onClick: this.btn_class_group_uploadHeadere, className: "am-btn am-btn-primary"}, "上传头像")
           ), 
           React.createElement("hr", null), 
		   React.createElement("div", {className: "am-form-group"}, 
	 	  	React.createElement(AMUIReact.Selected, {amSize: "xs", id: "groupuuid", name: "groupuuid", onChange: this.handleChange, btnWidth: "200", multiple: false, data: o.groupList, btnStyle: "primary", value: o.groupuuid}), 		     
		       ...
		       React.createElement("label", {className: one_classDiv}, "老师姓名:"), 
			     ...
			     React.createElement("div", {className: two_classDiv}, 
				   React.createElement(PxInput, {type: "text", id: "name", value: o.name, onChange: this.handleChange, onClick: w_ch_user.open.bind(this,"useruuid","name",o.groupuuid), placeholder: ""})
			        ), 

			    React.createElement("label", {className: one_classDiv}, "星级:"), 
			     React.createElement("div", {className: two_classDiv}, 
			       React.createElement(PxInput, {type: "text", name: "ct_stars", id: "ct_stars", maxLength: "20", value: o.ct_stars, onChange: this.handleChange})
			        ), 
