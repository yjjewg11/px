...
var modalInstance = (
		  React.createElement(ModalTrigger, {
		    modal: React.createElement(MyActions, null)}, 
		    React.createElement(Button, {amStyle: "primary"}, "Actions")
		  )
		);
...
var chooseUser_modal = React.createClass({displayName: "chooseUser_modal",
	  render: function() {
	    return (
	    		  React.createElement(AMUIReact_Modal, React.__spread({},  this.props, {type: "prompt", title: "老师选择"}), 
	    		  React.createElement("input", {type: "text", value: this.props.group_uuid})
	    		  )
	        );
	  }
	});
