...
var Right_EventRow = React.createClass({displayName: "Right_EventRow", 
  render: function() {
    ...
    return (
    		React.createElement(AMUIReact.Grid, {className: "doc-g"}, 
    	    React.createElement(AMUIReact.Col, {sm: 6}, React.createElement(Role_EventsTable, null)), 
    	    React.createElement(AMUIReact.Col, {sm: 6}, React.createElement(Right_EventsTable, null))
    	  )
    );
  }
}); 
