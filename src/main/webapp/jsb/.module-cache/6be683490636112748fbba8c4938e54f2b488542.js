...
var ChooseUser_EventsTable = React.createClass({displayName: "ChooseUser_EventsTable",
  ...
  React.createElement("hr", null)
      ...
      React.createElement("select", {id: "selectgroup_uuid_chuser", name: "group_uuid", "data-am-selected": "{btnSize: 'sm'}", value: this.state, onChange: this.handleChange_selectgroup_uuid_chuser}, 
