...
var Userinfo_EventsTable = React.createClass({displayName: "Userinfo_EventsTable",
  ...
  render: function() {
    ...
    React.createElement(AMR_ButtonToolbar, null, 
      ...
      React.createElement("select", {id: "selectgroup_uuid", name: "group_uuid", "data-am-selected": "{btnSize: 'sm'}", value: this.props.groupuuid, onChange: this.handleChange_selectgroup_uuid}, 
