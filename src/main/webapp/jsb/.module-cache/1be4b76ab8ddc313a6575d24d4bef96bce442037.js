...
var Classnewsreply_listshow = React.createClass({displayName: "Classnewsreply_listshow", 
	classnewsreply_list_div:"classnewsreply_list_div"+this.props.events.pageNo,
  ...
  return (
		  ...
		  this.props.events.data.map(function(event) {
		      return (
		    		  React.createElement(AMUIReact.Article, {
		  		    title: o.title, 
		  		    meta: o.create_user+" | "+o.update_time}, 
		  			React.createElement("div", {dangerouslySetInnerHTML: {__html: o.content}})
		  		   )	
		    		  )
		  }), 
		      React.createElement("button", {id: "btn_more_onClick_"+o.pageNo, type: "button", onClick: this.more_onClick.bind(this,o.pageNo+1), className: "am-btn am-btn-primary"}, "加载更多")
		    )
