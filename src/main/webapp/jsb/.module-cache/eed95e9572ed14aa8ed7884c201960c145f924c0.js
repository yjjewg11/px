	    		  ...
	    		  React.createElement("div", {id: "div_cookPlan_"+this.props.type}, 
 	 	            ...
 	 	            return (
 	 	            		React.createElement("div", {id: "div_cookPlan_Item_"+event.uuid, title: event.uuid, className: "G_cookplan_Img"}, 
		    	 	       			React.createElement("img", {id: "divCookItem_img_"+event.uuid, src: event.src, alt: "图片不存在", title: event.name}), 
		    	 	       			React.createElement("div", {className: "G_cookplan_Img_close", onclick: cookplan_deleteImg.bind(this,"div_cookPlan_Item_"+event.uuid)}, React.createElement("img", {src: hostUrl+"i/close.png", border: "0"})), 
