...
return (
		...
		React.createElement("input", {type: "hidden", name: "classuuid", value: o.classuuid}), 
		 React.createElement("label", {htmlFor: "name"}, "日期:"), 
		      React.createElement("input", {type: "text", name: "plandateStr", id: "plandateStr", value: o.plandate, onChange: this.handleChange, className: "am-form-field", "data-am-datepicker": "{format: 'yyyy-mm-dd'}"}), 
		      React.createElement("br", null), 
