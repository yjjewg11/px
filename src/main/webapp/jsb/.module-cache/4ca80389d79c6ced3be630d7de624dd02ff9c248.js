var Group_EventRow = React.createclassName({ 
  render: function() {
    var event = this.props.event;
    var classNameName = event.highlight ? 'am-active' :
      event.disabled ? 'am-disabled' : '';

    return (
      React.createElement("tr", {classNameName: classNameName}, 
...
var Group_EventsTable = React.createclassName({
  ...
  render: function() {
    ...
    var Group_edit = React.createclassName({ 
    	  ...
    	  render: function() {
    	    ...
    	    return (
    	    		...
    	    		React.createElement("htmlForm", {id: "editGrouphtmlForm", method: "post", className: "am-htmlForm"}, 
    	    	    ...
    	    	    React.createElement("input", {type: "hidden", name: "type", value: o.type}), 
    	    	      ...
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {htmlFor: ""}, "地址坐标:"), 
    	    	      ...
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {htmlFor: ""}, "公司电话:"), 
    	    	      React.createElement("input", {type: "text", name: "link_tel", id: "link_tel", value: o.link_tel, placeholder: ""}), 
    	    	      React.createElement("br", null), 
    	    	      React.createElement("button", {type: "button", onclick: "group_save()", className: "am-btn am-btn-primary"}, "提交")
    	    	     )
