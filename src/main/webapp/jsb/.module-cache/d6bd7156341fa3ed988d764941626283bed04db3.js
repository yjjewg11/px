...
var Group_EventRow = React.createClass({displayName: "Group_EventRow", 
  render: function() {
    ...
    return (
      ...
      React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: btn_group_myList.bind(this,"edit", event)}, event.brand_name)), 
...
return (
  React.createElement("tr", {className: className}, 
    React.createElement("td", null, React.createElement("a", {href: "javascript:btn_click_cookbookPlan('edit',null,'"+event.uuid+"')"}, G_week.getWeekStr(event.plandate))), 
...
React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
  ...
  React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: btn_click_classnews.bind(this,"edit", event)}, event.title)), 
  React.createElement("td", null, event.create_user), 
...
render: function() {
	...
	var maxPageNo=totalCount/pageSize+1;
	var that=this;
	var pre_enable=g_classnews_pageNo_point>1;
	var next_enable=g_classnews_pageNo_point<maxPageNo;
return (
React.createElement("div", null, 
React.createElement(AMUIReact.ButtonToolbar, null, 
	    React.createElement(AMUIReact.Button, {amStyle: "primary", onClick: this.handleClick.bind(this, "add_classnews"), round: true}, "添加")
	 ), 
	  React.createElement("hr", null), 
	  
	  React.createElement(AMR_Button, {amStyle: "secondary", disabled: false, onClick: this.handleClick.bind(this, "pre"), round: true}, "« 上一页"), 
	  React.createElement("label", null, g_classnews_pageNo_point, "\\", maxPageNo), 
	    React.createElement(AMR_Button, {amStyle: "secondary", disabled: true, onClick: this.handleClick.bind(this, "next"), round: true}, "下一页 »"), 
	    React.createElement(AMUIReact.Pagination, null, 
	      React.createElement(AMUIReact.Pagination.Item, {disabled: false, href: this.handleClick( "pre")}, "« 上一页"), 
	      React.createElement(AMUIReact.Pagination.Item, {disabled: true, href: this.handleClick( "next")}, "下一页 »")
	    ), 
		...
		React.createElement("div", {className: "am-g"}, 
		  ...
		  React.createElement("form", {id: "editClassnewsForm", method: "post", className: "am-form"}, 
			...
			React.createElement("label", {htmlFor: "title"}, "标题:"), 
		      React.createElement("input", {type: "text", name: "title", id: "title", value: o.title, onChange: this.handleChange, placeholder: "不超过15位"}), 
		      React.createElement("br", null), 
