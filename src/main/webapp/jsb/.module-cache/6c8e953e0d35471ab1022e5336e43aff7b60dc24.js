  ...
  return (
  		...
  		React.createElement("div", {className: "am-g"}, 
  		  ...
  		  React.createElement("form", {id: "editClassForm", method: "post", className: "am-form"}, 
  		    ...
  		    React.createElement("input", {type: "hidden", name: "teacher", id: "teacher", value: o.teacher, onClick: w_ch_user.open.bind(this,"teacher","teacher_name",o.groupuuid), onChange: this.handleChange}), 
