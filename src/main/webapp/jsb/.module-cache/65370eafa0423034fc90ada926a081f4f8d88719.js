...
var Classnews_EventsTable = React.createClass({displayName: "Classnews_EventsTable",
	handleClick: function(m) {
		 if(this.props.handleClick){
			 ...
			 ajax_cookbookPlan_listByGroup($('#selectgroup_uuid').val(),--g_classnews_pageNo_point);
			 return;
		 }else if(m=="next"){
			 ajax_cookbookPlan_listByGroup($('#selectgroup_uuid').val(),++g_classnews_pageNo_point);
			 return;
...
render: function() {
	...
	var pageSize=this.props.events.pageSize;
		...
		var next_enable=g_classnews_pageNo_point*pageSize<totalCount;
return (
React.createElement("div", null, 
React.createElement(AMUIReact.ButtonToolbar, null, 
	  ...
	  React.createElement("hr", null), 
	    React.createElement(AMUIReact.Pagination, null, 
	      React.createElement(AMUIReact.Pagination.Item, {active: pre_enable, href: "javascript:void(0);", onClick: this.handleClick.bind(this, "pre")}, "« 上一页"), 
	      React.createElement(AMUIReact.Pagination.Item, {active: next_enable, href: "javascript:void(0);", onClick: this.handleClick.bind(this, "next")}, "下一页 »")
	    ), 
