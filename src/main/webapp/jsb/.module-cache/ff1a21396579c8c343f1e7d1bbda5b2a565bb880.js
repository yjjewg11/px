    ...
    return (
	 ...
	 React.createElement(AMUIReact.Tabs, {defaultActiveKey: "1", justify: true}, 
	    React.createElement(AMUIReact.Tabs.Item, {eventKey: "1", title: "主食"}, 
	      ...
	      React.createElement("div", {id: "divCookItem_add", className: "G_ch_cook_item", onClick: w_ch_cook.add_img.bind(this,1)}, 
    	...
    	componentDidMount: function() {
    			...
    			$.ajax({
    				...
    				success : function(data) {
    					...
    					if (data.ResMsg.status == "success") {
    						Store.setChooseCook("cookbook_type_"+type,data.list)
    					} else {
    	  ...
    	  render: function() {
    		  var is_Checked=false;
    			  if(this.props.checkeduuids)is_Checked=this.props.checkeduuids.indexOf(event.uuid)>-1;
