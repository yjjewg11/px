		...
		React.createElement("div", {className: "am-g"}, 
		  React.createElement("div", {className: "am-u-lg-6 am-u-md-8 am-u-sm-centered"}, 
		    React.createElement("form", {id: "commonform", method: "post", className: "am-form"}, 
		      ...
		      React.createElement(UCheck, {type: "radio", name: "sex", label: "男", inline: true, checked: o.sex==0, onChange: this.handleChange}), 
		      React.createElement(UCheck, {type: "radio", name: "sex", label: "女", inline: true, checked: o.sex==1, onChange: this.handleChange}), 
		      React.createElement("br", null), 
