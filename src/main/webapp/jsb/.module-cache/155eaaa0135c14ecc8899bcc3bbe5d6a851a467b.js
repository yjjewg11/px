...
var Group_EventsTable = React.createClass({displayName: "Group_EventsTable",
  ...
  render: function() {
    ...
    var Group_edit = React.createClass({displayName: "Group_edit", 
    	  render: function() {
    	    return (
    	    		React.createElement("form", {id: "editGroupform", method: "post", class: "am-form"}, 
    	    		React.createElement("input", {type: "hidden", name: "uuid", value: "1"}), 
    	    	    React.createElement("input", {type: "hidden", name: "type", value: "1"}), 
    	    	      React.createElement("label", {for: "brand_name"}, "品牌名:"), 
    	    	      React.createElement("input", {type: "email", name: "brand_name", id: "brand_name", value: "", placeholder: "机构名不能为空！，且长度不能超过45位！"}), 
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {for: "company_name"}, "机构全称:"), 
    	    	      React.createElement("input", {type: "text", name: "company_name", id: "company_name", value: "", placeholder: "机构名不能为空！，且长度不能超过45位！"}), 
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {for: "address"}, "公司地址:"), 
    	    	      React.createElement("input", {type: "text", name: "address", id: "address", value: "", placeholder: "联系地址不能为空！，且长度不能超过64位！"}), 
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {for: ""}, "地址坐标:"), 
    	    	      React.createElement("input", {type: "text", name: "map_point", id: "map_point", value: "", placeholder: "拾取坐标后，复制到这里。格式：104.074822,30.6623"}), 
    	    	      React.createElement("a", {href: "http://api.map.baidu.com/lbsapi/getpoint/index.html", target: "_blank"}, "坐标拾取"), 
    	    	      React.createElement("br", null), 
    	    	       React.createElement("label", {for: ""}, "公司电话:"), 
    	    	      React.createElement("input", {type: "text", name: "link_tel", id: "link_tel", value: "", placeholder: ""}), 
    	    	      React.createElement("button", {type: "button", onclick: "group_save()", class: "am-btn am-btn-primary"}, "提交")
    	    	     )
    	    );
    	  }
    	}); 
