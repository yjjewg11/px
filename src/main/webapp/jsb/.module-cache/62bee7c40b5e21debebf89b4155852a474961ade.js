...
render: function() {
  ...
  return (
    ...
    React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
      ...
      React.createElement("td", null, event.description), 
      React.createElement("td", null, AdminVo.role_type(event.type))
    ) 
  );
}
}); 
...
render: function() {
  ...
  React.createElement(AMUIReact.ButtonToolbar, null, 
    ...
    React.createElement("option", {value: "0"}, AdminVo.role_type(0)), 
    React.createElement("option", {value: "1"}, AdminVo.role_type(1))
    )
  ), 
