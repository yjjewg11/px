...
var modalInstance = (
  React.createElement(AMUIReact_ModalTrigger, {modal: modal}, 
    React.createElement(AMUIReact_Button, {amStyle: "primary"}, "打开 Modal 窗口")
  )
);
...
//chooseUser
var chooseUser_modal =  React.createClass({displayName: "chooseUser_modal", 
	  render: function() {
		  React.createElement(AMUIReact_Modal, {type: "prompt", title: "老师选择"}, 
		    React.createElement(ChooseUser_EventsTable, React.__spread({},  props))
		  )
	  }
	});
...
var ChooseUser_modalInstance = React.createClass({displayName: "ChooseUser_modalInstance", 
	  render: function() {
		  React.createElement(AMUIReact_ModalTrigger, {
		    modal: chooseUser_modal, 
		    onCancel: onCancel, 
		    onConfirm: onConfirm}, 
		    React.createElement(Button, {amStyle: "warning"}, "模拟 Prompt")
		  )
	  }
});
/**
