	  ...
	  ajax_cookbookPlan_list:function(uuids){
		...
		deleteImg:function(divid){
		 ...
		 btn_addCookplan: function(divid) {
			 var that=this;
			  var checkeduuids=$("#"+divid+" > .G_cookplan_Img").attr("title");
			 alert("checkeduuids="+checkeduuids);
	  ...
	  render: function() {
	    ...
	    return (
	    		  React.createElement("div", {id: "div_cookPlan_"+this.props.type}, 
 	 	            ...
 	 	            return (
 	 	            		React.createElement("div", {id: "div_cookPlan_Item_"+event.uuid, title: event.uuid, className: "G_cookplan_Img", onClick: that.div_onClick.bind(this,"divCookItem_"+event.uuid)}, 
