...
render: function() {
  ...
  return (
    ...
    React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
      ...
      React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: this.react_ajax_class_students_manage.bind(this, event.uuid)}, event.name)), 
