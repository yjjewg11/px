...
React.createElement(AMUIReact.ButtonToolbar, null, 
	  ...
	  React.createElement("hr", null), 
	    React.createElement(AMUIReact.Pagination, null, 
	      React.createElement(AMUIReact.Pagination.Item, {href: "javascript:void(0);", onClick: this.handleClick.bind(this, "pre")}, "« 上一页"), 
	      React.createElement(AMUIReact.Pagination.Item, {href: "javascript:void(0);", onClick: this.handleClick.bind(this, "next")}, "下一页 »")
	    ), 
