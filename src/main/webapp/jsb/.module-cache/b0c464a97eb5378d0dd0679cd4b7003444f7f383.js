...
React.createElement(AMUIReact.ButtonToolbar, null, 
	  ...
	  React.createElement(AMR_Button, {amStyle: "secondary", onClick: this.handleClick.bind(this, "pre"), round: true}, "« 上一页"), 
	  React.createElement("label", null, "Male"), 
	    React.createElement(AMR_Button, {amStyle: "secondary", onClick: this.handleClick.bind(this, "next"), round: true}, "下一页 »"), 
	    React.createElement(AMUIReact.Pagination, null, 
	      React.createElement(AMUIReact.Pagination.Item, {active: false, href: this.handleClick( "pre")}, "« 上一页"), 
	      React.createElement(AMUIReact.Pagination.Item, {active: next_enable, href: this.handleClick( "next")}, "下一页 »")
	    ), 
