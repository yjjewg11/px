...
var Right_EventRow = React.createClass({displayName: "Right_EventRow", 
	...
	ajax_right_edit_onClick:function(s){
		ajax_right_button_handleClick(s);
	},
  ...
  render: function() {
    ...
    return (
		 React.createElement("tr", {id: "tr_chright_"+event.uuid, className: className}, 
	      React.createElement("td", null, 
	      React.createElement("input", {type: "checkbox", alt: event.name, value: event.uuid, id: "tb_cbox__chright"+event.uuid, name: "table_checkbox_right", onClick: this.tr_onClick.bind(this,"tr_chright_"+event.uuid,"tb_cbox__chright"+event.uuid)})
	      ), 
