	  ...
	  React.createElement(AMUIReact_ButtonToolbar, null, 
		  ...
		  React.createElement(AMUIReact_Panel, null, 
			  React.createElement(AMUIReact_Grid, {className: "doc-g"}, 
			    React.createElement(AMUIReact_Col, {sm: 12, md: 5, lg: 4}, " 班级:", o.name), 
			    React.createElement(AMUIReact_Col, {sm: 12, md: 7, lg: 8}, "班主任:", o.headTeacher_name), 
			    React.createElement(AMUIReact_Col, {sm: 12, md: 7, lg: 8}, "其他老师:", o.teacher_name)
			  )
		  ), 
