...
var ChooseUser_modalInstance1 = (
  React.createElement(AMUIReact_ModalTrigger, {modal: chooseUser_modal, onCancel: onCancel, onConfirm: onConfirm}, 
...
var ChooseUser_modalInstance =(
		  React.createElement(AMUIReact_ModalTrigger, React.__spread({
		    modal: modal, 
		    onCancel: onCancel, 
		    onConfirm: onConfirm},  this.props), 
		    React.createElement(AMUIReact_Button, {amStyle: "primary"}, "选")
		  )
	  );
/**
