	...
	render: function() {
	  ...
	  return (
	  		React.createElement("div", null, 
	  			...
	  			React.createElement("button", {type: "button", onClick: btn_ajax_updateRight.bind(this, o.useruuid), className: "am-btn am-btn-primary"}, "提交"), 
		  		React.createElement(UserChooseRole_EventRow, React.__spread({},  this.props))
...
React.createElement("div", null, 
  ...
  React.createElement(AMUIReact.Table, React.__spread({},  this.props), 
    ...
    React.createElement("tbody", null, 
      this.props.events.map(function(event) {
        return (React.createElement(UserChooseRole_EventRow, {event: event}));
      })
    )
  )
  )
