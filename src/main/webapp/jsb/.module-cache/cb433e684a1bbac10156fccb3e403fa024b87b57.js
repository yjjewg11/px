...
var Upload_headImg = React.createClass({displayName: "Upload_headImg",
       	 ...
       	 componentDidMount:function(){
       		 $('#upload_file').on('change', function(){
                 ...
                 reader.onload = function(e) {
                     ...
                     w_uploadImg.cropper = $('#upload_file_imageBox').cropbox(options);
                 }
                 reader.readAsDataURL(this.files[0]);
                 this.files = [];
             });
       		 $('#imageBox_loading').hide();
       ...
       React.createElement("div", {className: "container"}, 
	   	React.createElement("div", {className: "imageBox", id: "upload_file_imageBox"}, 
	   	    ...
	   	    React.createElement("div", {className: "spinner", id: "imageBox_loading"}, "加载中...")
	   	), 
   	React.createElement("div", {className: "action"}, 
   	React.createElement("input", {type: "hide", id: "upload_file_base64"}), 
