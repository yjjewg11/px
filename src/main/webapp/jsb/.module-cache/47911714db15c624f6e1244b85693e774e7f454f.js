...
var Right_EventsTable = React.createClass({displayName: "Right_EventsTable",
  ...
  render: function() {
    ...
    React.createElement(AMR_ButtonToolbar, null, 
	    React.createElement(AMR_Button, {amStyle: "primary", onClick: this.handleClick.bind(this, "add_right"), round: true}, "添加")
	 ), 
	  React.createElement("hr", null), 
	  React.createElement("div", {className: "am-form-group"}, 
      React.createElement("select", {id: "select_right_type", name: "group_uuid", "data-am-selected": "{btnSize: 'sm'}", value: this.props.type, onChange: this.handleChange_select_right_type}, 
