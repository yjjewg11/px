...
return (
  ...
  React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
    ...
    React.createElement("td", null, React.createElement("a", {href: "javascript:react_ajax_class_students_manage('"+event.uuid+"')"}, event.plandate)), 
	  ...
	  render: function() {
	    ...
	    return (
	    		  React.createElement("div", {id: "div_cookplan_"+this.props.type}, 
 	 	            ...
 	 	            return (
 	 	            		React.createElement("div", {id: "div_cookplan_Item_"+event.uuid, title: event.uuid, className: className, onClick: that.div_onClick.bind(this,"divCookItem_"+event.uuid)}, 
		    	 	       			React.createElement("img", {id: "divCookItem_img_"+event.uuid, src: G_imgPath+event.img, alt: "图片不存在", title: event.name}), 
		    	 	       			React.createElement("span", {id: "divCookItem_name_"+event.uuid, title: event.name}, event.name)
		    	 	       		)		
 	 	            	);
 	 	          }), 
...
return (
		...
		React.createElement("input", {type: "hidden", name: "uuid", value: o.uuid}), 
		    ...
		    React.createElement("div", {className: "am-form-group"}, 
		      ...
		      React.createElement("label", null, "早餐:"), "  ", React.createElement("button", {type: "button", onClick: ajax_cookbookPlan_save, className: "am-btn am-btn-primary"}, "添加"), 
		      React.createElement("input", {type: "hidden", name: "time_1", id: "time_1", value: o.time_1, onChange: this.handleChange}), 
		      React.createElement(AMR_Gallery, {data: o.time_1_arr, sm: 3, md: 4, lg: 6}), 
