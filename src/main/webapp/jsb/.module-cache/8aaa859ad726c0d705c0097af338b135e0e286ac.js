...
//cookbookPlan
var CookbookPlan_EventRow = React.createCookbookPlan({ 
render: function() {
var event = this.props.event;
var className = event.highlight ? 'am-active' :
  event.disabled ? 'am-disabled' : '';
...
var CookbookPlan_EventsTable = React.createCookbookPlan({
render: function() {
return (
React.createElement("div", null, 
React.createElement(AMR_Sticky, null, 
...
React.createElement(AMR_Button, {amStyle: "primary", onClick: this.handleClick.bind(this, "next"), round: true}, "下周"), "   ")
  ...
  React.createElement(AMR_Table, React.__spread({},  this.props), 
    ...
    React.createElement("tbody", null, 
      this.props.events.map(function(event) {
        return (React.createElement(CookbookPlan_EventRow, {key: event.id, event: event}));
      })
    )
  )
  )
...
var CookbookPlan_edit = React.createCookbookPlan({ 
	 getInitialState: function() {
		    return this.props.formdata;
		  },
	 handleChange: function(event) {
...
var AMR_Grid=AMUIReact.Grid;
var AMR_Col=AMUIReact.Col;
var CookbookPlan_students_manage = React.createCookbookPlan({
	 componentDidMount:function(){
			 G_img_down404();
...
var CookbookPlan_student_edit = React.createCookbookPlan({ 
	 getInitialState: function() {
		    return this.props.formdata;
		  },
	 handleChange: function(event) {
		    this.setState($('#editCookbookPlanStudentForm').serializeJson());
	  },
	  componentDidMount:function(){
		  var imgGuid=this.state.headimg;
		 if(imgGuid){
...
return (
		...
		React.createElement("div", {className: "am-g"}, 
		  React.createElement("div", {className: "am-u-lg-6 am-u-md-8 am-u-sm-centered"}, 
		  React.createElement("form", {id: "editCookbookPlanStudentForm", method: "post", className: "am-form"}, 
		React.createElement("input", {type: "hidden", name: "uuid", value: o.uuid}), 
		     React.createElement("input", {type: "hidden", name: "classuuid", value: o.classuuid}), 
		React.createElement("input", {type: "hidden", name: "headimg", id: "headimg", value: o.headimg, onChange: this.handleChange}), 
		      React.createElement("label", {htmlFor: "name"}, "姓名:"), 
