    		...
    		React.createElement("div", {className: "am-g"}, 
    		  ...
    		  React.createElement("form", {id: "editUserinfoForm", method: "post", className: "am-form"}, 
    		    ...
    		    React.createElement("div", {className: "am-form-group"}, 
    		      ...
    		      React.createElement("input", {type: "text", name: "name", id: "name", value: o.name, onChange: this.handleChange, placeholder: "长度不能超过15位！"}), 
    		      React.createElement("br", null), 
  		...
  		React.createElement("div", {className: "am-g"}, 
  		  ...
  		  React.createElement("form", {id: "editClassForm", method: "post", className: "am-form"}, 
  		    ...
  		    React.createElement("div", {className: "am-form-group"}, 
  		      ...
  		      React.createElement("input", {type: "text", name: "name", id: "name", value: o.name, onChange: this.handleChange, placeholder: "长度不能超过45位！"}), 
  		      React.createElement("br", null), 
