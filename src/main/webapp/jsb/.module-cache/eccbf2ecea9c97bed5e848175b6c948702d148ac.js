...
render: function() {
 ...
 return (
 		...
 		React.createElement("input", {type: "hidden", name: "headimg", id: "headimg", value: o.headimg, onChange: this.handleChange}), 
			...
			React.createElement(AMUIReact.DateTimeInput, {format: "YYYY-MM-DD", name: "birthday", id: "birthday", value: o.birthday, onChange: this.handleChange}), 
 		      React.createElement("br", null), 
...
return (
		...
		React.createElement("input", {type: "hidden", name: "classuuid", value: o.classuuid}), 
		 ...
		 React.createElement(AMUIReact.DateTimeInput, {format: "YYYY-MM-DD", name: "plandate", id: "plandate", value: o.plandate, onChange: this.handleChange}), 
		      React.createElement("br", null), 
