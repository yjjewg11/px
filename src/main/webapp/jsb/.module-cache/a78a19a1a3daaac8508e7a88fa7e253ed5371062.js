...
var Class_students_manage = React.createClass({displayName: "Class_students_manage",
	render: function() {
	  ...
	  React.createElement(AMR_Sticky, null, 
	  React.createElement(AMR_ButtonToolbar, null, 
		    React.createElement(AMR_Button, {amStyle: "primary", onClick: class_students_manage_onClick.bind(this, "add_class",this.props.formdata.uuid), round: true}, "添加学生")
		  )
		  ), 
		  React.createElement("hr", null), 
...
render: function() {
 ...
 return (
 		...
 		React.createElement("input", {type: "hidden", name: "headimg", value: o.headimg}), 
 		    ...
 		    React.createElement(AMUIReact.Image, {src: hostUrl+"i/header.png", responsive: true}), 
