		 ...
		 if(this.props.handleClick){
			 ...
			 $($("input[.G_ch_cook_item_checked]")).each(function(){
				 uuids+=this.alt;
					 ...
					 var tmpO={};
					 tmpO.src=this.src;
					 tmpO.name=$("#divCookItem_name_"+this.alt).Attr(alt);
      	 ...
      	 var event = this.props.event;
    	    return (
    	    		  React.createElement("div", {id: "div_cook_"+this.props.type}, 
     	 	            ...
     	 	            return (
     	 	            		React.createElement("div", {id: "divCookItem_"+event.uuid, alt: event.uuid, className: className, onClick: that.div_onClick.bind(this,"divCookItem_"+event.uuid)}, 
