...
render: function() {
  ...
  return (
		  ...
		  React.createElement(AMUIReact.Article, {
		   ...
		   React.createElement("div", {class: "dianzan"}, "♡", o.dianzan
		   ), 
		   React.createElement("button", {type: "button", onClick: ajax_classnews_dianzan_save, className: "am-btn am-btn-primary"}, "点赞"), 
