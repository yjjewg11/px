...
var Basedatalist_EventsTable = React.createClass({displayName: "Basedatalist_EventsTable",
  render: function() {
    ...
    return (
      ...
      React.createElement("button", {type: "button", onClick: ajax_basedatalist_button_handleClick.bind(this, "add",this.props.type), className: "am-btn am-btn-primary"}, "添加权限")
      )
    );
  }
});
