				  ...
				  this.props.formdata.data.map(function(event) {
					...
					React.createElement("article", {className: "am-comment-highlight"}, 
					  React.createElement("div", {className: "am-comment-main"}, 
						  ...
						  React.createElement("div", {className: "am-comment-bd", onClick: this.ajax_State_style.bind(this,event.type,event.rel_uuid)}, event.message)
					  )
					))						
				  })
...
var Announcements_Div_kuang = React.createClass({displayName: "Announcements_Div_kuang", 
	render: function() {
		  return (
	   ...
	   React.createElement("div", {className: "am-list-news-hd am-cf"}, 
	     React.createElement("h2", null, "栏目标题")
	     ), 	      	      
  ...
  return (			
	 ...
	 var Announcements_mylist_div = React.createClass({displayName: "Announcements_mylist_div", 
	    ...
	    return (
	    		     ...
	    		     React.createElement("li", {className: "am-g"}, 
	    		       React.createElement("a", {href: "javascript:void(0);", onClick: react_ajax_announce_show.bind( this, event.uuid)}, event.title), 
