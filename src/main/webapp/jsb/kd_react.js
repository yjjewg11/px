				  ...
				  this.props.formdata.data.map(function(event) {
					...
					React.createElement("article", {className: "am-comment-highlight"}, 
					  React.createElement("div", {className: "am-comment-main"}, 
						  ...
						  React.createElement("div", {className: "am-comment-bd", onClick: this.ajax_State_style.bind(this,event.type,event.rel_uuid,event.group_uuid)}, event.message)
					  )
					))						
				  })
	...
	render: function() {
	  ...
	  return (
	    ...
	    React.createElement("input", {type: "checkbox", value: event.uuid, name: "table_checkbox"})
	      ...
	      React.createElement("td", null, React.createElement("a", {href: "javascript:void(0);", onClick: react_ajax_announce_show.bind(this,event.uuid,Vo.announce_type(event.type))}, event.title)), 
		...
		render: function() {
		 ...
		 return (
		    	...
		    	this.props.formdata.map(function(event) {
		            ...
		            React.createElement(AMR_ButtonToolbar, null, 		            
		            React.createElement(AMUIReact.Button, {onClick: ajax_boss_message_list.bind(this,event.send_useruuid,event.revice_useruuid,event.send_user), amStyle: "success"}, "@信息"), "你们总共发了", event.count, "条信息"
		            )	
...
* */
var Boss_student_tel2 =React.createClass({displayName: "Boss_student_tel2",
	render: function() {
	 return (
			 React.createElement("div", {className: "am-g"}, 
	...
	render: function() {
		  return (
				  ...
				  this.props.events.data.map(function(event) {
				      ...
				      React.createElement("div", {className: "am-cf"}, 
				      React.createElement("div", {className: "am-fl"}, event.send_user, ":"), 
				      React.createElement("div", {className: "am-fl", dangerouslySetInnerHTML: { __html: event.message}})
				      )
				    	  ))
				  })
				    )				   
  ...
  return (
		  React.createElement("div", {className: "G_reply"}, 
		   ...
		   React.createElement("div", {id: this.classnewsreply_list_div}
			...
			React.createElement("button", {id: this.load_more_btn_id, type: "button", onClick: this.load_more_data.bind(this), className: "am-btn am-btn-primary"}, "加载更多"), 		
			React.createElement("button", {type: "button", onClick: this.btn_reply_save.bind(this), className: "am-btn am-btn-primary"}, "评论"), 
...
return (
		   React.createElement("form", {id: "editClassnewsreplyForm", method: "post", className: "am-form"}, 
			...
			React.createElement(AMR_Input, {id: this.classnews_content, type: "textarea", rows: "10", label: "我要回复", placeholder: "填写内容", name: "content"}), 
	  		        ...
	  		        React.createElement(AMR_Button, {amStyle: "success", round: true}, "邀请全部")	
	  	  	       ...
	  	  	       React.createElement(AMUIReact.List, {static: true}, 
	  	  			this.props.formdata.map(function(event) {
	  	  		        ...
	  	  		        React.createElement(AMUIReact.Button, {onClick: ajax_parentContactByMyStudent_message_list.bind(this,event.parent_uuid,"来自"+event.student_name+event.typename+"的信息"), amStyle: "success"}, "@信息"), 	
	  	  		        ListItem
	  	  		        )
	  	  		        ));
	  	  		      })		      			      
		...
		render: function() {
		 ...
		 return (
		    	...
		    	this.props.formdata.map(function(event) {
		            return (React.createElement(AMUIReact.ListItem, null, "家长", event.send_user, "的信息",     
		            React.createElement(AMR_ButtonToolbar, null, 		            
		            React.createElement(AMUIReact.Button, {onClick: ajax_parentContactByMyStudent_message_list.bind(this,event.send_useruuid,"来自"+event.send_user+"的信息"), amStyle: "success"}, "@信息"), "你们总共发了", event.count, "条信息"
		            )	        
		            ));
		          })		      			      
			      )
