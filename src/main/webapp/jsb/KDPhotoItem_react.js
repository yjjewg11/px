...
render: function() {	
    ...
    return (
    		...
    		React.createElement(AMUIReact.Selected, {id: "classuuid", name: "classuuid", placeholder: "班级切换", onChange: this.handleChange_selectgrou_uuid, btnWidth: "200", data: this.props.classList, btnStyle: "primary", value: obj.class_uuid})		            
    		 ), 
