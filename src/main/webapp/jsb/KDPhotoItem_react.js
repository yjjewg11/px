		  ...
		  React.createElement("div", {"data-am-widget": "list_news", className: "am-list-news am-list-news-default"}, 
		   React.createElement(AMR_Panel, null, 
		    React.createElement(AMR_ButtonToolbar, null, 
 		     React.createElement(AMR_Button, {amSize: "xs", amStyle: "secondary", onClick: this.phtot_Click.bind(this,obj)}, "精品相册")
   		    )
		   ), 
...
//	    }
	    ...
	    return (    		
		    React.createElement("div", {className: "am-comment-bd"}, 
		     React.createElement(Common_mg_Class_big_fn, {imgsList: imgarry, Penthat: this.props.Propsthat})
		    )
	    );
	  }
	});
...
return (
   React.createElement("div", null, 
	React.createElement("ul", {className: "am-gallery am-avg-sm-4 am-avg-md-6 am-avg-lg-12 am-gallery-imgbordered"}, 
	...
	return (
		 React.createElement("li", {id: "Common_mg_Class_big_fn_item_"+ event.uuid, className: "G_class_phtoto_Img G_ch_classNews_item"}, 			     			
		  React.createElement("div", {className: "am-gallery-item"}, 
			   React.createElement("a", {href: imgArr[0], title: ""}, 
			    ...
			    React.createElement("span", {className: "G_class_phtoto_label "+label_className}, label_text), 
      ...
      React.createElement("div", {className: "G_class_phtoto_Img_close", onClick: that.handleClick.bind(this,event,KDitemthis)}
...
render: function() {	
    ...
    return (
    		...
    		React.createElement("div", {className: "header"}, 
    		  ...
    		  React.createElement("input", {type: "hidden", name: "note", value: o.queryForm.note}), 
    		  React.createElement(AMR_ButtonToolbar, null, 
        		React.createElement("div", {className: "am-fl am-margin-left-sm am-margin-bottom-xs"}, 
		      ...
		      G_upload_img_Div, 
		      React.createElement(AMR_ButtonToolbar, null, 
    		    React.createElement(AMR_Button, {amSize: "xs", disabled: o.photoNum<o.photoAllNum, amStyle: "secondary", onClick: this.buttion_black_Click.bind(this,o)}, "确认返回"), 
    		    React.createElement(AMR_Button, {amSize: "xs", disabled: o.photoNum<o.photoAllNum, className: buttion_LestGo_className, amStyle: "secondary", onClick: this.buttion_LestGo.bind(this)}, "继续上传")
    		  )
