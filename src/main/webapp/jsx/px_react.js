...
return (
		...
		<div className="am-g">
	      ...
	      <div>
		  <AMUIReact.Selected id="selectclass_uuid" name="classuuid" inline multiple= {true} onChange={this.handleClick_selected} btnWidth="300"  data={this.props.mycalsslist} btnStyle="primary" value={o.classuuid} />	      
          </div>
	       <div>
  
          <input id=" pw_checked" name="pw_checked"    type="checkbox" checked={g_checkflag}  onChange={this.handleClick_box_btn}/>
	 	  选中全部班级
  ...
  render: function() {
    ...
    return (
		   ...
		   <label className={one_classDiv }>摘要:</label>
    		 <div className={two_classDiv }>
    	      <PxInput type="text" name="summary" id="summary" value={o.summary}  maxlength="100" onChange={this.handleChange} placeholder="不超过100字"/>
    	       </div> 		
	...
	<G_px_help_List data={G_px_help_msg.msg_px_help_list13_1}/>
       ...
       <AMR_ButtonToolbar>
  	  ...
  	  <AMUIReact.Selected amSize="xs" id="selectclass_uuid2" name= "class_uuid" onChange={this.handleChange_selectclass.bind(this)} btnWidth= "200" data={this.props.classList} btnStyle="primary" value={o.uuid}/>    
  	    ...
  	    <div className="am-fl am-margin-left-sm am-margin-bottom-xs">
     	<AMUIReact.Selected  amSize="xs" btnStyle="secondary" placeholder="更多操作" onChange={this.handleClick_download.bind(this,o.groupuuid,o.uuid)} btnWidth="200"  multiple= {false} data={this.props.down_list}/>   
     	</div>
	  </AMR_ButtonToolbar>
  ...
  **/
  ...
  render: function() {
   ...
   return (
		   ...
		   <div className={two_classDiv}>
   	      <PxInput type="text" name="title" id="title" value={o.title} onChange={this.handleChange} placeholder="不超过64字"/>
 		 </div>	
		  <label className={one_classDiv}>金额:</label>
		   ...
		   <div className={two_classDiv}>
	  	  <PxInput type="text" name="description" id="description" value={o.description} onChange={this.handleChange} placeholder="不超过100字"/>
		 </div>
		 <div className="am-fl  am-margin-left-xs">
     ...
     <div>
		  ...
		  <AMR_Panel>
		   <AMR_ButtonToolbar>
			  <a name="top"></a>
           <div className="am-fl am-margin-bottom-sm am-margin-left-xs">	
		   <AMR_Button  amStyle="secondary" onClick={this.addteachingplan_btn.bind(this,"add",{classuuid:o.classuuid,uuid:null})} >增加单条课程</AMR_Button>
		   </div>  
           <div className="am-fl am-margin-bottom-sm am-margin-left-xs">	
		   <AMR_Button  amStyle="secondary" onClick={this.add_classbtn.bind(this)}>批量添加课程</AMR_Button>	  	  
		   </div>  
		   <div className="am-fl am-margin-bottom-sm am-margin-left-xs">
		   <AMR_Button  amStyle="danger" onClick={this.Alldeletes_btn.bind(this)}>删除所有课程</AMR_Button>
	       </div> 
		   </AMR_ButtonToolbar>
          </AMR_Panel>
 		...
 		render: function() {
 		 ...
 		 return (
 			 ...
 			 <AMUIReact.ListItem>课程详细内容:
					...
					<div dangerouslySetInnerHTML={{__html: "<div class='am-gallery'>"+o.context+"</div>"}}></div>
 		    </div> 
 		     );
 	        }
 		 }); 
   ...
   render: function() {
	  ...
	  var iframe=null;
	     ...
	     iframe=(       
            ...
            <div dangerouslySetInnerHTML={{__html: "<div class='am-gallery'>"+o.message+"</div>"}}></div>
			</AMUIReact.Article>)
	     }
   return (
   		  <div>
...
<a href="javascript:void(0);" onClick={common_check_illegal.bind(this,o.type,o.uuid)}  className="am-fr">举报</a>
			   
   		    	</div>
   		    	</footer>
   		    	<Common_Dianzan_show_noAction uuid={o.uuid} type={o.type}  btn_dianzan={"btn_dianzan_"+o.uuid}/>
   			  <Common_reply_list uuid={o.uuid}  type={o.type}   groupuuid={o.groupuuid}/>			 
   		   </div>
   );
   }
   }); 
		...
		render: function() {
		 ...
		 return (
			    ...
			    <AMUIReact.ListItem>老师介绍详细内容:	 
				 <div dangerouslySetInnerHTML={{__html: "<div class='am-gallery'>"+o.content+"</div>"}}></div>
				</AMUIReact.ListItem>		 			       			      
			 </AMUIReact.List> 		
		    </div> 
		     );
