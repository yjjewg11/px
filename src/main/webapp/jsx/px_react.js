 ...
 * */
  ...
  render: function() {
   ...
   return (
		   ...
		   <div>
		   <button type="button" className={"am-btn am-btn-secondary"}  onClick={this.btn_ajax_classStudent_admin_byRight.bind(this,o.groupuuid,o.uuid)} >换班级</button>
	 ...
	 <div className="am-fl am-margin-bottom-sm am-margin-left-xs">
      ...
      <div className="am-panel am-panel-default">      
        ...
        <div id={"do-not-say-"+event.uuid} className="am-panel-collapse am-collapse">
          ...
          <AMR_ButtonToolbar>
		  <AMR_Button amSize="xs" amStyle="secondary" onClick={thit.addteachingplan_btn.bind(this,event)} >修改</AMR_Button>
 	    ...
 	    var event = this.props.event;
 	 	var className = event.highlight ? 'am-active' :
 	  	...
 	  	return (
			...
			<td><AMR_Button amSize="xs" amStyle="secondary" onClick={this.handleChange_button.bind(this,"addclass",event)} >复制课程</AMR_Button></td>
 	  	    <td><AMR_Button amSize="xs" amStyle="secondary" onClick={this.handleChange_button.bind(this,"eitclass",event)} >修改</AMR_Button></td>
