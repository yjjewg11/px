...
//btn_query_All_className:	显示-查询我的班级；
  ...
  return (			
		  <div data-am-widget="list_news" className="am-list-news am-list-news-default">
		   ...
		   <AMR_Panel>
		    <AMR_ButtonToolbar>
		     <AMR_Button  amSize="xs"  amStyle="secondary" onClick={this.phtot_class_Click.bind(this,obj)} >班级相册</AMR_Button>
  		    </AMR_ButtonToolbar>
		   </AMR_Panel> 
	...
	<ul  className="am-gallery am-avg-sm-3 am-avg-md-4 am-avg-lg-6 am-gallery-imgbordered">
	   {this.props.imgsList.map(function(event) {
    	...
    	if(create_useruuid==useruuid){
    		editDiv= <AMR_Button amSize="xs"  amStyle="secondary" onClick={that.div_onClick.bind(this,event)} >编辑</AMR_Button>;
    	}
 ...
 *精品相册预览层
 * */
var Photo_move_div = React.createClass({
render: function() {	
    return (
       <div id="list_div">
     
       <iframe id="t_iframe"  onLoad={G_iFrameHeight.bind(this,'t_iframe')}  frameborder="0" scrolling="auto" marginheight="0" marginwidth="0"  width="100%" height="600px" src={this.props.share_url}></iframe>
       <p>分享地址:</p>
       <p>{this.props.share_url}</p>
       </div>    	
    ...
    return (
        ...
        <AMR_ButtonToolbar>
         ...
         <div className="am-fl am-margin-left-sm am-margin-bottom-xs">
		  <AMR_Button amSize="xs"  amStyle="secondary" onClick={this.bg_Class_fn.bind(this)} >选择图片</AMR_Button>
		 </div> 
		 <div className="am-fl am-margin-left-sm am-margin-bottom-xs">
		  <AMR_Button amSize="xs"  amStyle="secondary" onClick={this.buttion_fpmove.bind(this,o)} >{tenokate}</AMR_Button>
		 </div> 
		 <div className="am-fl am-margin-left-sm am-margin-bottom-xs">
