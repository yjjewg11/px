...
render: function() {	
    ...
    return (
    		...
    		<div className="header">
		      ...
		      {G_upload_img_Div} 
		      <AMR_ButtonToolbar>
    		    <AMR_Button amSize="xs"  amStyle="secondary" onClick={this.buttion_black_Click.bind(this,o)} >确定</AMR_Button>
    		    <AMR_Button amSize="xs"  className={buttion_LestGo_className} amStyle="secondary" onClick={this.buttion_LestGo.bind(this)} >继续上传</AMR_Button>
    		  </AMR_ButtonToolbar>
