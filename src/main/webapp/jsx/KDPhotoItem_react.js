...
render: function() {	
    ...
    return (
    		...
    		<AMR_Button amStyle="default" onClick={this.pageClick.bind(this, "pre",o)} >上一页</AMR_Button>
    		  <AMR_Button amStyle="default" disabled="false" >第{obj.pageNo}页</AMR_Button>
    		<AMR_Button amStyle="default" onClick={this.pageClick.bind(this, "next",o)} >下一页</AMR_Button>	
    		...
    		<AMUIReact.Selected id="classuuid" name="classuuid" placeholder="班级切换"  onChange={this.handleChange_selectClass} btnWidth="200"  data={this.props.classList} btnStyle="primary" value={obj.class_uuid} />    		            
			    ...
			    <div className="am-comment-bd">
			    	<Common_mg_Class_big_fn  imgsList={imgphotoList}  type={this.props.type}/>
...
render: function() {	
    ...
    return (
    		...
    		<div className="am-g">
    		  ...
    		  <input type="hidden" name="class_uuid"  value={o.class_uuid}/> 
    		  <AMR_ButtonToolbar>
