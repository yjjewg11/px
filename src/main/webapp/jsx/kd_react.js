	  ...
	  return (
			  ...
			  <div className="am-comment-main">
			    ...
			    <div dangerouslySetInnerHTML={{__html:o.content}}></div>
			    	...
			    	<a href="javascript:void(0);" onClick={common_illegal.bind(this,99,o.uuid)}>举报</a>
			    	</div>
			    	</footer>
		  ...
		  <AMUIReact.Article
			...
			<div dangerouslySetInnerHTML={{__html: o.message}}></div>
		     ...
		     <AMR_Button  amStyle="success" onClick={this.favorites_push.bind(this,o.title,o.type,o.uuid)} round>收藏</AMR_Button> 
		    	...
		    	<div className="am-comment-actions">
		    	<a href="javascript:void(0);"><i id={"btn_dianzan_"+o.uuid} className="am-icon-thumbs-up px_font_size_click"></i></a> 
		    	<a href="javascript:void(0);" onClick={common_illegal.bind(this,3,o.uuid)}>举报</a>
		    	</div>
		    	</footer>
		    	<Common_Dianzan_show_noAction uuid={o.uuid} type={0}  btn_dianzan={"btn_dianzan_"+o.uuid}/>
			  <Common_reply_list uuid={o.uuid}  type={0}/>			 
	  ...
	  <div>	 
		  <AMR_Panel>
			  <AMR_Grid className="doc-g">
		  	  <AMR_ButtonToolbar>
	  		    <AMR_Button amStyle="primary" onClick={class_students_manage_onClick.bind(this,o.uuid,o.name)} round>查看课程</AMR_Button>
		...
		render: function() {
		 ...
		 return (
		    	...
		    	{this.props.formdata.map(function(event) {
		            ...
		            <AMR_ButtonToolbar>		            
		            <AMUIReact.Button  onClick={ajax_parentContactByMyStudent_message_list.bind(this,event.send_useruuid,"我的信箱")} amStyle="success">@信息</AMUIReact.Button>你们总共发了{event.count}条信息
		            </AMR_ButtonToolbar>	        
		            </AMUIReact.ListItem>);
		          })}		      			      
			      </AMUIReact.List>
	...
	render: function() {
	  ...
	  return (
	    <tr className={className} >
	      ...
	      <th>{Vo.get("announce_status_"+event.type)}</th>
	      <td>{event.count}</td>
	      <td>{event.create_time}</td>
	  ...
	  <div>
       ...
       <AMUIReact.Article
		...
		<div dangerouslySetInnerHTML={{__html: o.message}}></div>
	     ...
	     <AMR_Button  amStyle="success" onClick={this.favorites_push.bind(this,o.title,o.type,o.uuid)} round>收藏</AMR_Button> 
	     <AMR_Button amStyle="danger" onClick={common_check_illegal.bind(this,o.type,o.uuid)} round>举报</AMR_Button>
	  ...
	  return (
			  ...
			  <div className="am-comment-main">
			    ...
			    <div dangerouslySetInnerHTML={{__html:o.content}}></div>
			    	...
			    	<Common_Dianzan_show_noAction uuid={o.uuid} type={0}  btn_dianzan={"btn_dianzan_"+o.uuid}/>
			    	<ul className="am-comments-list">
					  <Classnews_reply_list_byRight uuid={o.uuid}  type={0} btn_reply={"btn_reply_"+o.uuid}/>
			    	</ul>
			     </div>
			</article>
...
var Teachingplan_EventRow_byRight = React.createClass({ 
	...
	return (
	  <tr className={className} >
	    <td><a href="javascript:void(0);" onClick={btn_click_teachingplan_byRight.bind( this, "edit",event.uuid)}>{G_week.getWeekStr(event.plandate)}</a></td>
	    <td>{event.morning}</td>
	    <td>{event.afternoon}</td>
	  </tr> 
	);
	 	...
	 	<div>
	 	  <hr/>
	 	    <ul className="am-list am-list-static am-list-border">
	           ...
	           <AMR_ButtonToolbar>		            
	         <AMUIReact.Button  onClick={ajax_my_boss_stage_byRight.bind(this,event.send_useruuid,event.revice_useruuid,event.send_user)} amStyle="success">@信息</AMUIReact.Button>你们总共发了{event.count}条信息
	        </AMR_ButtonToolbar>
	       </li>);})}		      			      
		 </ul>
	 	</div> 		 
