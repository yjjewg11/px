  ...
  **/
  ...
  render: function() {
   ...
   return (
		   ...
		   <div className={two_classDiv}>
	 	    <PxInput icon="calendar" type="text" maxLength="10" placeholder="YYYY-MM-DD" name="accounts_timeStr" id="accounts_timeStr" value={o.accounts_time} onChange={this.handleChange}/> 		   		
	 		 </div>	
